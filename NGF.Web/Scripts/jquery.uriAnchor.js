...
(function ($) {
  $.uriAnchor = (function () {
    ...
    //Added by Moses Zhu on 20170210
    getCleanAnchorStringByUrl = function (url) {
    ...
    //End Added by Moses Zhu on 20170210
    ...
    makeAnchorMap = function (tUrl) {
      ...
      if (tUrl != undefined && tUrl != null) {
          anchor_string = getCleanAnchorStringByUrl(tUrl);
      }
      //End Added by Moses Zhu
