...
[assembly: WebResource("WSC.Res.MultiListBox.moveAllLeft.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.moveAllLeft2.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.moveAllRight.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.moveAllRight2.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.moveLeft.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.moveLeft2.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.moveRight.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.moveRight2.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.sortDown.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.sortDown2.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.sortUp.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.sortUp2.gif", "image/gif")]
[assembly: WebResource("WSC.Res.MultiListBox.MultiListBox.js", "text/javascript")]
...
namespace WSC.WebControls
{
    ...
    public class MultiListBox : CompositeControl, IPostBackDataHandler
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            sb.AppendFormat("var multiList=new MultiListBox('{2}',document.getElementById('{1}_firstListBox'),document.getElementById('{1}_secondListBox'),'{1}_');{0}", Environment.NewLine, this.ClientID,selectLisxBoxType);
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            ...
            writer.RenderEndTag();
            writer.AddAttribute(HtmlTextWriterAttribute.Width, "30px");
        ...
        public enum SelectLisxBoxType : byte
        {          
            Text,
            Image
        }
        ...
        /// 样式的选择
        /// </summary>
         [WebCategory("Behavior"), Browsable(true), DefaultValue(0), Description("选择的样式是图片还是Text")]
        public SelectLisxBoxType selectLisxBoxType
        {
            get
            {

                object obj = ViewState["SelectLisxBoxType"];
                return (obj == null) ? SelectLisxBoxType.Image : (SelectLisxBoxType)obj;
            }
            set
            {
                ViewState["SelectLisxBoxType"] = value;
            }
        }
        /// <summary>
        /// 
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            {
                //注册脚本
                string jsResource = Page.ClientScript.GetWebResourceUrl(typeof(MultiListBox), "WSC.Res.MultiListBox.MultiListBox.js");
        ...
        protected void RenderMultiIcon(HtmlTextWriter writer)
        {
            ...
            if (selectLisxBoxType == SelectLisxBoxType.Text)
            {
                //writer.RenderBeginTag(HtmlTextWriterTag.Div);
                writer.RenderBeginTag(HtmlTextWriterTag.Table);
                RenderTextContents(writer, "moveAllRight.gif", "&raquo", "multiList.transferAllLeft();", "_AllRight");//全部右移
                RenderTextContents(writer, "moveRight.gif", "&gt;", "multiList.transferRight();", "_Right");
                RenderTextContents(writer, "moveLeft.gif", "&lt;", "multiList.transferLeft();", "_Left");
                RenderTextContents(writer, "moveAllLeft.gif", "&laquo;", "multiList.transferAllRight();", "_AllLeft");
                writer.RenderEndTag();
            }
            else
            {
                writer.RenderBeginTag(HtmlTextWriterTag.Div);
               // writer.RenderBeginTag(HtmlTextWriterTag.Table);
                RenderImageContents(writer, "moveAllRight.gif", "&raquo", "multiList.transferAllLeft();", "_AllRight");//全部右移
                ...
                RenderImageContents(writer, "moveAllLeft.gif", "&laquo;", "multiList.transferAllRight();", "_AllLeft");
                writer.RenderEndTag();
            }
        }
        ...
        {
            return Page.ClientScript.GetWebResourceUrl(typeof(MultiListBox), "WSC.Res.MultiListBox." + img);
        }
        ...
        private void RenderImageContents(HtmlTextWriter writer, string imgFileName,string imgValue, string jsClickName, string imgClientName)
        {
        ...
        private void RenderTextContents(HtmlTextWriter writer, string imgFileName, string imgValue, string jsClickName, string imgClientName)
        {
            writer.RenderBeginTag(HtmlTextWriterTag.Tr);
            ...
            writer.AddAttribute(HtmlTextWriterAttribute.Name, this.ClientID + imgClientName);
            writer.AddAttribute(HtmlTextWriterAttribute.Id, this.ClientID + imgClientName);
            writer.AddAttribute(HtmlTextWriterAttribute.Value, imgValue, false);
            writer.AddAttribute(HtmlTextWriterAttribute.Onclick, jsClickName);
