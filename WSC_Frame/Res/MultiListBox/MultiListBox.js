function MultiListBox(buttontype,firstListBox,secondListBox,clientID)
{
...
MultiListBox.prototype.oninitStatusText=function()
{
     var listCount=this.FirstListBox.options.length;
     if (listCount>1){
         $(this.ClientID+"AllRight").disabled=false;
         $(this.ClientID+"Right").disabled=false;
         $(this.ClientID+"AllRight").style.color="black";
         $(this.ClientID+"Right").style.color="black";
     }
     else if (listCount==1){
         $(this.ClientID+"Right").disabled=false;  
         $(this.ClientID+"AllRight").disabled=false;
     ...
     {
         $(this.ClientID+"AllRight").disabled=true;     
         $(this.ClientID+"Right").disabled=true;
         $(this.ClientID+"AllRight").style.color="grey";    
         $(this.ClientID+"Right").style.color="grey";
     }
     listCount=this.SecondListBox.options.length;
     if (listCount>1){
         $(this.ClientID+"AllLeft").disabled=false;
         $(this.ClientID+"Left").disabled=false;
         $(this.ClientID+"AllLeft").style.color="black";
         $(this.ClientID+"Left").style.color="black";
     }
     else if (listCount==1){
         $(this.ClientID+"AllLeft").disabled=false;
         $(this.ClientID+"Left").disabled=false;
     ...
     {
         $(this.ClientID+"AllLeft").disabled=true;
         $(this.ClientID+"Left").disabled=true;
         $(this.ClientID+"AllLeft").style.color="grey";
         $(this.ClientID+"Left").style.color="grey";
     }
}
